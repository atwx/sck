<div class="header_nav_strip nav_strip--$Version nav_strip--mega-menu">
    <div class="nav_container">
        <a href="/" class="nav_brand">
            <% if $SiteConfig.WhiteLogo && $SiteConfig.HeaderLogo %>
                ...
                <img class="nav_brand_color" src="$SiteConfig.HeaderLogo.URL" alt="Alternative Logo">
            <% else_if $SiteConfig.HeaderLogo %>
                <img class="nav_brand_color" src="$SiteConfig.HeaderLogo.URL" alt="Cuxhaven Logo">
                <img class="nav_brand_white" src="$SiteConfig.HeaderLogo.URL" alt="Cuxhaven Logo">
